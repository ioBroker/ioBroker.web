        ...
        return (
            <form style={styles.tab}>
                ...
                <div style={{ ...styles.column, ...styles.columnSettings, position: 'relative' }}>
                    ...
                    />
                    {userListSettings && this.state.users ? (
                        <div>
                            <div>
                                ...
                                >
                                    <MenuItem value="_">{I18n.t('logged in user')}</MenuItem>
                                        ...
                                        >
                                            <div style={{ display: 'flex' }}>
                                                <Checkbox
                                                    ...
                                                    onChange={() => {
                                                        const _userListSettings = JSON.parse(
                                                            JSON.stringify(native.userListSettings),
                                                        );
                                            ...
                                            >
                                                <div style={{ display: 'flex' }}>
                                                    <Checkbox
                                                        ...
                                                        checked={
                                                            native.userListSettings.users.includes(user._id) || inGroup
                                                        }
                                                    />
                                                    <TextWithIcon
                                                        value={user}
                                                ...
                                                >
                                                    ...
                                                    {this.state.groups
                                                        ?.filter(group => group.common.members.includes(user._id))
                                                        .map(group => (
                                                            <TextWithIcon
                                                                key={group._id}
                                                                value={group}
